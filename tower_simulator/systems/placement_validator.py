...
class PlacementValidator:
    ...
    def _check_level_restrictions(self, room_type: str, coordinate: Coordinate, height: int) -> bool:
        ...
        # Lobby - Can be placed on level 1 or above
        if room_type == 'lobby':
            return coordinate.level >= 1
        ...
        # Service modules - Can be placed anywhere
        ...
        # Transit (stairs, escalator) - Can be placed at any level
        ...
        if room_type == 'metro_station':
            return 1 <= coordinate.level <= 3  # B1-B3 (levels 1-3 in our system)
    ...
    def _check_valid_placement(self, coordinate: Coordinate, width: int, height: int) -> bool:
        ...
        """
        # Level 0 (ground) is always valid
